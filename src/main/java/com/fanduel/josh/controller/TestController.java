...
public class TestController {
    ...
    public Mono<TestObj> getById(@PathVariable("id") String id) {
        return reactiveStringRedisTemplate.opsForHash().get("testKey", id)
                .map(string -> {
                    try {
...
//    @GetMapping("{id}")
//    public Mono<Test> getById(@PathVariable("id") String id) {
//        return reactiveStringRedisTemplate.opsForValue().get(id)
//                .map(string -> {
//                    try {
//                        return objectMapper.readValue(string, Test.class);
//                    } catch (JsonProcessingException e) {
//                        throw new RuntimeException(e);
//                    }
//                });
...
//    @PostMapping("{id}")
//    public Mono<Boolean> post(@PathVariable("id") String id,
//                              @RequestBody Test test) throws JsonProcessingException {
